...
const Review = () => {
  ...
  return (
    <>
      <div className="w-full mx-auto z-40 md:relative md:-top-12  xl:-top-20 min-[1100px]:-top-20 mt-10 md:mt-0">
        <div className="container ">
          <div class="rounded-[24px] bg-[#fff] shadow-lg p-4 md:py-6 md:px-20 flex justify-between items-center ">
            <div className="w-full flex justify-between">
              <div
                className="counter-box d-flex flex-column align-items-center justify-content-center
                                    colored"
              >
